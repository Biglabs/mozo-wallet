 ...
 * @param {function} splashOptions.callBackInit callback function after closing splash screen
 */
  constructor(mainWindow, splashOptions) {
    ...
    this.splashOptions = {
      ...
      callBackInit: splashOptions.callBackInit
    };
  ...
  init() {
    ...
    this.splashWindow.webContents.on('dom-ready', async () => {
      ...
      setTimeout(async () => {
        if(typeof this.splashOptions.callBackInit === 'function') {
          this.splashOptions.callBackInit()
        } else {
