...
var map = {
	...
	"./pages/phrase/phrase.module": [
		"./src/app/pages/phrase/phrase.module.ts",
		"pages-phrase-phrase-module"
	],
	"./pages/pin-confirm/pin-confirm.module": [
...
function initializer(keycloak, eventStackService, appService) {
    var _this = this;
    return function () {
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            var initKeycloak_1, error_1;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        keycloak.keycloakEvents$.subscribe(function (event) {
                            eventStackService.triggerEvent(event);
                        });
                        initKeycloak_1 = function (token, refreshToken) { return __awaiter(_this, void 0, void 0, function () {
                            var initOptions;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        if (token && refreshToken) {
                                            initOptions = __assign({}, initOptions, { token: token, refreshToken: refreshToken });
                                        }
                        ...
                        return [4 /*yield*/, appService.getSetting(['token', 'refreshToken']).then(function (data) {
                                if (data) {
                                    initKeycloak_1(data["token"], data["refreshToken"]);
                                }
                                else {
                                    initKeycloak_1(null, null);
                                }
                            }, function (error) {
                                initKeycloak_1(null, null);
                            })];
...
/* harmony import */ var _pages_send_confirm_send_confirm_page__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./pages/send-confirm/send-confirm.page */ "./src/app/pages/send-confirm/send-confirm.page.ts");
...
var AppRoutingModule = /** @class */ (function () {
    ...
    AppRoutingModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            entryComponents: [
                _pages_send_confirm_send_confirm_page__WEBPACK_IMPORTED_MODULE_2__["SendConfirmPage"]
            ]
        })
    ], AppRoutingModule);
...
module.exports = "<ion-app>\n  <ion-router-outlet></ion-router-outlet>\n</ion-app>\n<!-- <ion-button *ngIf=\"true\" (click)=\"onLogin()\">Login</ion-button>-->\n \n"
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [3 /*break*/, 4];
                                case 1:
                                    if (!this.keycloakService["_instance"]) return [3 /*break*/, 3];
                                    return [4 /*yield*/, this.appService.addSetting({
                                ...
                                case 3:
                                    ...
                                    this.mozoService.getUserProfile().subscribe(function (res) {
                                        var data = res.body;
                                        if (data["walletInfo"]) {
                                            _this.appGlobals.saveEncryptSeedWord(data.walletInfo.encryptSeedPhrase);
                                            console.log("user", data);
                                            _this.appService.getSetting(['Address']).then(function (data) {
                                            ...
                                            _this.router.navigateByUrl("/phrase");
                                        }
                                    }, function (error) {
...
var AppGlobals = /** @class */ (function () {
    function AppGlobals(events) {
        this.events = events;
        this.userInfo = null;
        this.encryptSeedWord = null;
        this.seedWord = null;
        this.address = null;
        this.txData = null;
    }
    AppGlobals.prototype.updateUserInfo = function (userInfo) {
        this.userInfo = userInfo;
        this.events.publish('user:update', userInfo);
    };
    AppGlobals.prototype.saveEncryptSeedWord = function (encryptSeedWord) {
...
/* harmony import */ var keycloak_angular__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! keycloak-angular */ "./node_modules/keycloak-angular/fesm5/keycloak-angular.js");
/* harmony import */ var _app_initilizer__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./app-initilizer */ "./src/app/app-initilizer.ts");
...
/* harmony import */ var _app_globals__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./app.globals */ "./src/app/app.globals.ts");
/* harmony import */ var _core_services_event_stack_service__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./core/services/event-stack.service */ "./src/app/core/services/event-stack.service.ts");
/* harmony import */ var _pages_send_confirm_send_confirm_module__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./pages/send-confirm/send-confirm.module */ "./src/app/pages/send-confirm/send-confirm.module.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            imports: [
                ...
                _pages_send_confirm_send_confirm_module__WEBPACK_IMPORTED_MODULE_18__["SendConfirmPageModule"],
                keycloak_angular__WEBPACK_IMPORTED_MODULE_12__["KeycloakAngularModule"],
            ...
            providers: [
                ...
                _app_globals__WEBPACK_IMPORTED_MODULE_16__["AppGlobals"],
                { provide: _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouteReuseStrategy"], useClass: _ionic_angular__WEBPACK_IMPORTED_MODULE_6__["IonicRouteStrategy"] },
                {
                    provide: _angular_core__WEBPACK_IMPORTED_MODULE_0__["APP_INITIALIZER"],
                    useFactory: _app_initilizer__WEBPACK_IMPORTED_MODULE_13__["initializer"],
                    multi: true,
                    deps: [keycloak_angular__WEBPACK_IMPORTED_MODULE_12__["KeycloakService"], _core_services_event_stack_service__WEBPACK_IMPORTED_MODULE_17__["EventStackService"], _app_service__WEBPACK_IMPORTED_MODULE_15__["AppService"]]
                }
            ],
...
var AppService = /** @class */ (function () {
    ...
    AppService.prototype.getSetting = function (params) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            this.http.get(this.url + "/setting", { params: params, observe: 'response' })
                                .subscribe(function (res) {
                                var data = res.body["data"] || null;
                                resolve(data);
                            }, function (error) {
                                reject(error);
                            });
    ...
    AppService.prototype.deleteSetting = function (params) {
        if (params === void 0) { params = []; }
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            this.http.delete(this.url + "/setting", { params: params, observe: 'response' })
                                .subscribe(function (res) {
                                var data = res.body["data"] || null;
                                resolve(data);
                            }, function (error) {
    ...
    AppService.prototype.addSetting = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            this.http.post(this.url + "/setting", data, { observe: 'response' })
                                .subscribe(function (res) {
                                var data = res.body["data"] || null;
                                resolve(data);
                            }, function (error) {
...
/* harmony import */ var _pin_code_pin_code_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./pin-code/pin-code.component */ "./src/app/components/pin-code/pin-code.component.ts");
    ...
    ComponentsModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [
                ...
                _pin_code_pin_code_component__WEBPACK_IMPORTED_MODULE_4__["PinCodeComponent"],
...
module.exports = ".loading-container {\n  height: 100px; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "<img class=\"app-logo\" src=\"./assets/svg/mozo.svg\" />"
...
module.exports = ".app-logo {\n  height: 24px; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/***/ "./src/app/components/pin-code/pin-code.component.html":
/*!*************************************************************!*\
  !*** ./src/app/components/pin-code/pin-code.component.html ***!
  \*************************************************************/
/*! no static exports found */
...
module.exports = "<ion-grid full-height no-padding>\n  <ion-row align-items-start >\n    <ion-col size=\"12\">\n      <div text-center margin-vertical>\n        <ion-icon color=\"medium\" class=\"pin-code\" size=\"large\" [name]=\"pin.length>0 ? 'radio-button-on' : 'radio-button-off'\"></ion-icon>\n        <ion-icon color=\"medium\" class=\"pin-code\" size=\"large\" [name]=\"pin.length>1 ? 'radio-button-on' : 'radio-button-off'\"></ion-icon>\n        <ion-icon color=\"medium\" class=\"pin-code\" size=\"large\" [name]=\"pin.length>2 ? 'radio-button-on' : 'radio-button-off'\"></ion-icon>\n        <ion-icon color=\"medium\" class=\"pin-code\" size=\"large\" [name]=\"pin.length>3 ? 'radio-button-on' : 'radio-button-off'\"></ion-icon>\n        <ion-icon color=\"medium\" class=\"pin-code\" size=\"large\" [name]=\"pin.length>4 ? 'radio-button-on' : 'radio-button-off'\"></ion-icon>\n        <ion-icon color=\"medium\" class=\"pin-code\" size=\"large\" [name]=\"pin.length>5 ? 'radio-button-on' : 'radio-button-off'\"></ion-icon>\n      </div>\n    </ion-col>\n  </ion-row>\n  <ion-row class=\"key-board\" align-items-end padding-horizontal>\n    <ion-col size=\"4\" text-left>\n      <ion-button class=\"circle\" size=\"large\" fill=\"outline\" (click)=\"handleInput('1')\">1</ion-button>\n    </ion-col>\n    <ion-col size=\"4\" text-center>\n      <ion-button class=\"circle\" size=\"large\" fill=\"outline\" (click)=\"handleInput('2')\">2</ion-button>\n    </ion-col>\n    <ion-col size=\"4\" text-right>\n      <ion-button class=\"circle\" size=\"large\" fill=\"outline\" (click)=\"handleInput('3')\">3</ion-button>\n    </ion-col>\n    <ion-col size=\"4\" text-left>\n      <ion-button class=\"circle\" size=\"large\" fill=\"outline\" (click)=\"handleInput('4')\">4</ion-button>\n    </ion-col>\n    <ion-col size=\"4\" text-center>\n      <ion-button class=\"circle\" size=\"large\" fill=\"outline\" (click)=\"handleInput('5')\">5</ion-button>\n    </ion-col>\n    <ion-col size=\"4\" text-right>\n      <ion-button class=\"circle\" size=\"large\" fill=\"outline\" (click)=\"handleInput('6')\">6</ion-button>\n    </ion-col>\n    <ion-col size=\"4\" text-left>\n      <ion-button class=\"circle\" size=\"large\" fill=\"outline\" (click)=\"handleInput('7')\">7</ion-button>\n    </ion-col>\n    <ion-col size=\"4\" text-center>\n      <ion-button class=\"circle\" size=\"large\" fill=\"outline\" (click)=\"handleInput('8')\">8</ion-button>\n    </ion-col>\n    <ion-col size=\"4\" text-right>\n      <ion-button class=\"circle\" size=\"large\" fill=\"outline\" (click)=\"handleInput('9')\">9</ion-button>\n    </ion-col>\n    <ion-col size=\"4\" text-left>\n      <ion-button class=\"circle\" fill=\"outline\" size=\"large\" (click)=\"handleInput('clear')\">\n        <ion-icon name=\"refresh\"></ion-icon>\n      </ion-button>\n    </ion-col>\n    <ion-col size=\"4\" text-center>\n      <ion-button class=\"circle\" size=\"large\" fill=\"outline\" (click)=\"handleInput('0')\">0</ion-button>\n    </ion-col>\n    <ion-col size=\"4\" text-right>\n      <ion-button class=\"circle\" fill=\"outline\" size=\"large\" (click)=\"handleInput('backspace')\">\n        <ion-icon name=\"backspace\"></ion-icon>\n      </ion-button>\n    </ion-col>\n  </ion-row>\n</ion-grid>"

/***/ }),

/***/ "./src/app/components/pin-code/pin-code.component.scss":
/*!*************************************************************!*\
  !*** ./src/app/components/pin-code/pin-code.component.scss ***!
  \*************************************************************/
/*! no static exports found */
...
module.exports = "pin-code ion-icon.pin-code {\n  margin: 10px; }\n\n.circle {\n  --width: 50px;\n  --height: 50px;\n  --border-radius: 50%;\n  --vertical-align: middle;\n  --padding-start: 0;\n  --padding-end: 0; }\n\n.key-board {\n  max-width: 300px;\n  margin-left: auto;\n  margin-right: auto; }\n\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/components/pin-code/pin-code.component.ts":
/*!***********************************************************!*\
  !*** ./src/app/components/pin-code/pin-code.component.ts ***!
  \***********************************************************/
...
var PinCodeComponent = /** @class */ (function () {
    ...
    PinCodeComponent.prototype.handleInput = function (pin) {
        if (pin === "clear") {
            this.pin = "";
        }
    ...
    ], PinCodeComponent.prototype, "change", void 0);
    PinCodeComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'pin-code',
            template: __webpack_require__(/*! ./pin-code.component.html */ "./src/app/components/pin-code/pin-code.component.html"),
            styles: [__webpack_require__(/*! ./pin-code.component.scss */ "./src/app/components/pin-code/pin-code.component.scss")]
        }),
        __metadata("design:paramtypes", [])
    ], PinCodeComponent);
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm5/common.js");
/* harmony import */ var _services_event_stack_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./services/event-stack.service */ "./src/app/core/services/event-stack.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CoreModule = /** @class */ (function () {
    ...
    CoreModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [],
            providers: [_services_event_stack_service__WEBPACK_IMPORTED_MODULE_2__["EventStackService"]]
        })
    ], CoreModule);
    return CoreModule;
}());
...
/***/ "./src/app/core/services/event-stack.service.ts":
/*!******************************************************!*\
  !*** ./src/app/core/services/event-stack.service.ts ***!
  \******************************************************/
/*! exports provided: EventStackService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EventStackService", function() { return EventStackService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var EventStackService = /** @class */ (function () {
    function EventStackService() {
        this._eventTriggerSource = new rxjs__WEBPACK_IMPORTED_MODULE_1__["Subject"]();
        this._nextId = 0;
        this._eventStack = [];
        this.eventTriggered$ = this._eventTriggerSource.asObservable();
    }
    EventStackService.prototype.purgeEventItem = function (eventItemId) {
        var idx = this._eventStack.findIndex(function (eventItem) { return eventItem._id === eventItemId; });
        this._eventStack.splice(idx, 1);
    };
    EventStackService.prototype.triggerEvent = function (event) {
        this._nextId += 1;
    ...
    Object.defineProperty(EventStackService.prototype, "eventStack", {
        get: function () {
    ...
    EventStackService = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])({
            providedIn: 'root'
        }),
        __metadata("design:paramtypes", [])
    ], EventStackService);
    return EventStackService;
}());
...
/***/ "./src/app/helpers/EncryptionUtils.js":
/*!********************************************!*\
  !*** ./src/app/helpers/EncryptionUtils.js ***!
  \********************************************/
/*! no static exports found */
...
module.exports.convertToHash = function (inputPIN){
    ...
    let sha512 = __webpack_require__(/*! js-sha512 */ "./node_modules/js-sha512/src/sha512.js");
...
function ba(a,b,d){if(4!==b.length)throw new sjcl.exception.invalid("invalid aes block size");var c=a.i[d],e=b[0]^c[0],f=b[d?3:1]^c[1],g=b[2]^c[2];b=b[d?1:3]^c[3];var h,k,l,m=c.length/4-2,n,p=4,r=[0,0,0,0];h=a.M[d];a=h[0];var t=h[1],I=h[2],H=h[3],x=h[4];for(n=0;n<m;n++)h=a[e>>>24]^t[f>>16&255]^I[g>>8&255]^H[b&255]^c[p],k=a[f>>>24]^t[g>>16&255]^I[b>>8&255]^H[e&255]^c[p+1],l=a[g>>>24]^t[b>>16&255]^I[e>>8&255]^H[f&255]^c[p+2],b=a[b>>>24]^t[e>>16&255]^I[f>>8&255]^H[g&255]^c[p+3],p+=4,e=h,f=k,g=l;for(n=
...
d,c=this.c,e=this.i,f=c[0],g=c[1],h=c[2],k=c[3],l=c[4],m=c[5],n=c[6],p=c[7],r=c[8],t=c[9],I=c[10],H=c[11],x=c[12],B=c[13],A=c[14],y=c[15],u;if("undefined"!==typeof Uint32Array){u=Array(160);for(var v=0;32>v;v++)u[v]=a[v]}else u=a;var v=f,q=g,w=h,J=k,L=l,K=m,X=n,M=p,D=r,C=t,T=I,N=H,U=x,O=B,Y=A,P=y;for(a=0;80>a;a++){if(16>a)b=u[2*a],d=u[2*a+1];else{d=u[2*(a-15)];var z=u[2*(a-15)+1];b=(z<<31|d>>>1)^(z<<24|d>>>8)^d>>>7;var E=(d<<31|z>>>1)^(d<<24|z>>>8)^(d<<25|z>>>7);d=u[2*(a-2)];var F=u[2*(a-2)+1],z=
(F<<13|d>>>19)^(d<<3|F>>>29)^d>>>6,F=(d<<13|F>>>19)^(F<<3|d>>>29)^(d<<26|F>>>6),Z=u[2*(a-7)],aa=u[2*(a-16)],Q=u[2*(a-16)+1];d=E+u[2*(a-7)+1];b=b+Z+(d>>>0<E>>>0?1:0);d+=F;b+=z+(d>>>0<F>>>0?1:0);d+=Q;b+=aa+(d>>>0<Q>>>0?1:0)}u[2*a]=b|=0;u[2*a+1]=d|=0;var Z=D&T^~D&U,ga=C&N^~C&O,F=v&w^v&L^w&L,ka=q&J^q&K^J&K,aa=(q<<4|v>>>28)^(v<<30|q>>>2)^(v<<25|q>>>7),Q=(v<<4|q>>>28)^(q<<30|v>>>2)^(q<<25|v>>>7),la=e[2*a],ha=e[2*a+1],z=P+((D<<18|C>>>14)^(D<<14|C>>>18)^(C<<23|D>>>9)),E=Y+((C<<18|D>>>14)^(C<<14|D>>>18)^(D<<
23|C>>>9))+(z>>>0<P>>>0?1:0),z=z+ga,E=E+(Z+(z>>>0<ga>>>0?1:0)),z=z+ha,E=E+(la+(z>>>0<ha>>>0?1:0)),z=z+d|0,E=E+(b+(z>>>0<d>>>0?1:0));d=Q+ka;b=aa+F+(d>>>0<Q>>>0?1:0);Y=U;P=O;U=T;O=N;T=D;N=C;C=M+z|0;D=X+E+(C>>>0<M>>>0?1:0)|0;X=L;M=K;L=w;K=J;w=v;J=q;q=z+d|0;v=E+b+(q>>>0<z>>>0?1:0)|0}g=c[1]=g+q|0;c[0]=f+v+(g>>>0<q>>>0?1:0)|0;k=c[3]=k+J|0;c[2]=h+w+(k>>>0<J>>>0?1:0)|0;m=c[5]=m+K|0;c[4]=l+L+(m>>>0<K>>>0?1:0)|0;p=c[7]=p+M|0;c[6]=n+X+(p>>>0<M>>>0?1:0)|0;t=c[9]=t+C|0;c[8]=r+D+(t>>>0<C>>>0?1:0)|0;H=c[11]=H+N|
0;c[10]=I+T+(H>>>0<N>>>0?1:0)|0;B=c[13]=B+O|0;c[12]=x+U+(B>>>0<O>>>0?1:0)|0;y=c[15]=y+P|0;c[14]=A+Y+(y>>>0<P>>>0?1:0)|0}};sjcl.hash.sha1=function(a){a?(this.c=a.c.slice(0),this.h=a.h.slice(0),this.f=a.f):this.reset()};sjcl.hash.sha1.hash=function(a){return(new sjcl.hash.sha1).update(a).finalize()};
...
function G(a,b){return function(){b.apply(a,arguments)}}sjcl.random=new sjcl.prng(6);
a:try{var S,fa,V,ia;if(ia="undefined"!==typeof module&&module.exports){var ja;try{ja=__webpack_require__(/*! crypto */ "./node_modules/crypto-browserify/index.js")}catch(a){ja=null}ia=fa=ja}if(ia&&fa.randomBytes)S=fa.randomBytes(128),S=new Uint32Array((new Uint8Array(S)).buffer),sjcl.random.addEntropy(S,1024,"crypto['randomBytes']");else if("undefined"!==typeof window&&"undefined"!==typeof Uint32Array){V=new Uint32Array(32);if(window.crypto&&window.crypto.getRandomValues)window.crypto.getRandomValues(V);else if(window.msCrypto&&window.msCrypto.getRandomValues)window.msCrypto.getRandomValues(V);
...
return d},add:function(a){return this.copy().addM(a)},sub:function(a){return this.copy().subM(a)},mul:function(a){"number"===typeof a&&(a=new this.o(a));var b,d=this.limbs,c=a.limbs,e=d.length,f=c.length,g=new this.o,h=g.limbs,k,l=this.maxMul;for(b=0;b<this.limbs.length+a.limbs.length+1;b++)h[b]=0;for(b=0;b<e;b++){k=d[b];for(a=0;a<f;a++)h[b+a]+=k*c[a];--l||(l=this.maxMul,g.cnormalize())}return g.cnormalize().reduce()},square:function(){return this.mul(this)},power:function(a){a=(new sjcl.bn(a)).normalize().trim().limbs;
var b,d,c=new this.o(1),e=this;for(b=0;b<a.length;b++)for(d=0;d<this.radix;d++){a[b]&1<<d&&(c=c.mul(e));if(b==a.length-1&&0==a[b]>>d+1)break;e=e.square()}return c},mulmod:function(a,b){return this.mod(b).mul(a.mod(b)).mod(b)},powermod:function(a,b){a=new sjcl.bn(a);b=new sjcl.bn(b);if(1==(b.limbs[0]&1)){var d=this.montpowermod(a,b);if(0!=d)return d}for(var c,e=a.normalize().trim().limbs,f=new this.o(1),g=this,d=0;d<e.length;d++)for(c=0;c<this.radix;c++){e[d]&1<<c&&(f=f.mulmod(g,b));if(d==e.length-
1&&0==e[d]>>c+1)break;g=g.mulmod(g,b)}return f},montpowermod:function(a,b){function d(a,b){var d=b%a.radix;return(a.limbs[Math.floor(b/a.radix)]&1<<d)>>d}function c(a,d){var c,e,f=(1<<l+1)-1;c=a.mul(d);e=c.mul(r);e.limbs=e.limbs.slice(0,k.limbs.length);e.limbs.length==k.limbs.length&&(e.limbs[k.limbs.length-1]&=f);e=e.mul(b);e=c.add(e).normalize().trim();e.limbs=e.limbs.slice(k.limbs.length-1);for(c=0;c<e.limbs.length;c++)0<c&&(e.limbs[c-1]|=(e.limbs[c]&f)<<g-l-1),e.limbs[c]>>=l+1;e.greaterEquals(b)&&
e.subM(b);return e}a=(new sjcl.bn(a)).normalize().trim();b=new sjcl.bn(b);var e,f,g=this.radix,h=new this.o(1);e=this.copy();var k,l,m;m=a.bitLength();k=new sjcl.bn({limbs:b.copy().normalize().trim().limbs.map(function(){return 0})});for(l=this.radix;0<l;l--)if(1==(b.limbs[b.limbs.length-1]>>l&1)){k.limbs[k.limbs.length-1]=1<<l;break}if(0==m)return this;m=18>m?1:48>m?3:144>m?4:768>m?5:6;var n=k.copy(),p=b.copy();f=new sjcl.bn(1);for(var r=new sjcl.bn(0),t=k.copy();t.greaterEquals(1);)t.halveM(),0==
(f.limbs[0]&1)?(f.halveM(),r.halveM()):(f.addM(p),f.halveM(),r.halveM(),r.addM(n));f=f.normalize();r=r.normalize();n.doubleM();p=n.mulmod(n,b);if(!n.mul(f).sub(b.mul(r)).equals(1))return!1;e=c(e,p);h=c(h,p);n={};f=(1<<m-1)-1;n[1]=e.copy();n[2]=c(e,e);for(e=1;e<=f;e++)n[2*e+1]=c(n[2*e-1],n[2]);for(e=a.bitLength()-1;0<=e;)if(0==d(a,e))h=c(h,h),--e;else{for(p=e-m+1;0==d(a,p);)p++;t=0;for(f=p;f<=e;f++)t+=d(a,f)<<f-p,h=c(h,h);h=c(h,n[t]);e=p-1}return c(h,1)},trim:function(){var a=this.limbs,b;do b=a.pop();
while(a.length&&0===b);a.push(b);return this},reduce:function(){return this},fullReduce:function(){return this.normalize()},normalize:function(){var a=0,b,d=this.placeVal,c=this.ipv,e,f=this.limbs,g=f.length,h=this.radixMask;for(b=0;b<g||0!==a&&-1!==a;b++)a=(f[b]||0)+a,e=f[b]=a&h,a=(a-e)*c;-1===a&&(f[b-1]-=d);this.trim();return this},cnormalize:function(){var a=0,b,d=this.ipv,c,e=this.limbs,f=e.length,g=this.radixMask;for(b=0;b<f-1;b++)a=e[b]+a,c=e[b]=a&g,a=(a-c)*d;e[b]+=a;return this},toBits:function(a){this.fullReduce();
a=a||this.exponent||this.bitLength();var b=Math.floor((a-1)/24),d=sjcl.bitArray,c=[d.partial((a+7&-8)%this.radix||this.radix,this.getLimb(b))];for(b--;0<=b;b--)c=d.concat(c,[d.partial(Math.min(this.radix,a),this.getLimb(b))]),a-=this.radix;return c},bitLength:function(){this.fullReduce();for(var a=this.radix*(this.limbs.length-1),b=this.limbs[this.limbs.length-1];b;b>>>=1)a++;return a+7&-8}};
...
sjcl.bn.pseudoMersennePrime=function(a,b){function d(a){this.initWith(a)}var c=d.prototype=new sjcl.bn,e,f;e=c.modOffset=Math.ceil(f=a/c.radix);c.exponent=a;c.offset=[];c.factor=[];c.minOffset=e;c.fullMask=0;c.fullOffset=[];c.fullFactor=[];c.modulus=d.modulus=new sjcl.bn(Math.pow(2,a));c.fullMask=0|-Math.pow(2,a%c.radix);for(e=0;e<b.length;e++)c.offset[e]=Math.floor(b[e][0]/c.radix-f),c.fullOffset[e]=Math.ceil(b[e][0]/c.radix-f),c.factor[e]=b[e][1]*Math.pow(.5,a-b[e][0]+c.offset[e]*c.radix),c.fullFactor[e]=
b[e][1]*Math.pow(.5,a-b[e][0]+c.fullOffset[e]*c.radix),c.modulus.addM(new sjcl.bn(Math.pow(2,b[e][0])*b[e][1])),c.minOffset=Math.min(c.minOffset,-c.offset[e]);c.o=d;c.modulus.cnormalize();c.reduce=function(){var a,b,d,c=this.modOffset,e=this.limbs,f=this.offset,p=this.offset.length,r=this.factor,t;for(a=this.minOffset;e.length>c;){d=e.pop();t=e.length;for(b=0;b<p;b++)e[t+f[b]]-=r[b]*d;a--;a||(e.push(0),this.cnormalize(),a=this.minOffset)}this.cnormalize();return this};c.sa=-1===c.fullMask?c.reduce:
function(){var a=this.limbs,b=a.length-1,d,c;this.reduce();if(b===this.modOffset-1){c=a[b]&this.fullMask;a[b]-=c;for(d=0;d<this.fullOffset.length;d++)a[b+this.fullOffset[d]]-=this.fullFactor[d]*c;this.normalize()}};c.fullReduce=function(){var a,b;this.sa();this.addM(this.modulus);this.addM(this.modulus);this.normalize();this.sa();for(b=this.limbs.length;b<this.modOffset;b++)this.limbs[b]=0;a=this.greaterEquals(this.modulus);for(b=0;b<this.limbs.length;b++)this.limbs[b]-=this.modulus.limbs[b]*a;this.cnormalize();
return this};c.inverse=function(){return this.power(this.modulus.sub(2))};d.fromBits=sjcl.bn.fromBits;return d};var W=sjcl.bn.pseudoMersennePrime;
...
5,7,7,8,11,14,14,12,6,9,13,15,7,12,8,9,11,7,7,12,7,6,15,13,11,9,7,15,11,8,6,6,14,12,13,5,14,13,13,7,5,15,5,8,11,14,14,6,14,6,9,12,9,12,5,15,8,8,5,12,9,12,5,14,6,8,13,6,5,15,13,11,11]})();"undefined"!==typeof module&&module.exports&&(module.exports=sjcl);"function"==="function"&&!(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = (function(){return sjcl}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));


/***/ }),

/***/ "./src/app/pages/save-address/save-address.page.html":
/*!***********************************************************!*\
  !*** ./src/app/pages/save-address/save-address.page.html ***!
  \***********************************************************/
/*! no static exports found */
...
module.exports = ".full-width {\n  width: 100%; }\n\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/pages/save-address/save-address.page.ts":
/*!*********************************************************!*\
  !*** ./src/app/pages/save-address/save-address.page.ts ***!
  \*********************************************************/
/*! exports provided: SaveAddressPage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SaveAddressPage", function() { return SaveAddressPage; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/index.js");
...
var SaveAddressPage = /** @class */ (function () {
    function SaveAddressPage(nav, fb, modalController, mozoService, appGlobals, loadingController) {
        this.nav = nav;
        this.fb = fb;
        this.modalController = modalController;
        this.mozoService = mozoService;
    ...
    SaveAddressPage.prototype.dismiss = function (data) {
    ...
    // }
    SaveAddressPage.prototype.onSubmit = function () {
        var _this = this;
        //this.presentLoading()
        this.isSending = true;
        var reqData = {
        ...
        this.mozoService.saveAddress(reqData).subscribe(function (res) {
            var data = res.body;
            if (data) {
                // this.balance = data['balance'] / 100
                //this.dismissLoading()
                _this.status = 'success';
                setTimeout(function () { _this.dismiss(); }, 500);
            }
    ...
    SaveAddressPage.prototype.ngOnInit = function () {
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", String)
    ], SaveAddressPage.prototype, "address", void 0);
    SaveAddressPage = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'save-address',
            template: __webpack_require__(/*! ./save-address.page.html */ "./src/app/pages/save-address/save-address.page.html"),
            styles: [__webpack_require__(/*! ./save-address.page.scss */ "./src/app/pages/save-address/save-address.page.scss")]
        }),
...
/***/ "./src/app/pages/send-confirm/send-confirm.module.ts":
/*!***********************************************************!*\
  !*** ./src/app/pages/send-confirm/send-confirm.module.ts ***!
  \***********************************************************/
/*! exports provided: SendConfirmPageModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SendConfirmPageModule", function() { return SendConfirmPageModule; });
...
/***/ "./src/app/pages/send-confirm/send-confirm.page.html":
/*!***********************************************************!*\
  !*** ./src/app/pages/send-confirm/send-confirm.page.html ***!
  \***********************************************************/
/*! no static exports found */
...
module.exports = "\n<ion-header>\n  <ion-toolbar>\n    <ion-buttons slot=\"start\">\n      <ion-back-button text=\"Back\"></ion-back-button>\n    </ion-buttons>\n    <ion-title text-center>\n      <app-logo></app-logo>\n    </ion-title>\n    <ion-buttons slot=\"end\">\n      <ion-button (click)=\"dismiss()\">Cancel</ion-button>\n    </ion-buttons>\n  </ion-toolbar>\n</ion-header>\n<ion-content padding>\n  <ion-grid full-height no-padding>\n    <ion-row full-height no-padding>\n      <ion-col height-85 size=\"12\" align-items-start>\n        <ion-list>\n          <ion-item mode=\"md\" no-inner-end no-padding lines=\"full\">\n            <ion-icon size=\"large\" src=\"assets/svg/send.svg\"></ion-icon>\n            &nbsp;<h6 text-wrap>Send</h6>\n          </ion-item>\n          <ion-item mode=\"md\" lines=\"full\" no-padding>\n            <ion-label position=\"floating\">Receiver Address</ion-label>\n            <ion-input readonly [value]=\"toAddress\" placeholder=\"Enter receiver wallet address or Mozo ID\"></ion-input>\n          </ion-item>\n          <ion-item mode=\"md\" input-icon lines=\"full\" no-padding>\n            <ion-label position=\"floating\">Amount</ion-label>\n            <ion-icon slot=\"start\" src=\"assets/svg/mozo-offchain.svg\"></ion-icon>\n            <ion-input readonly [value]=\"amount\" placeholder=\"Enter amount to send\">\n            </ion-input>\n          </ion-item>\n        </ion-list>\n      </ion-col>\n      <ion-col height-15 size=\"12\" align-items-end no-padding>\n        <ion-row align-items-end full-height no-padding>\n          <ion-col padding-bottom>\n            <ion-button (click)=\"continue()\" align-items-end shadow\n              expand=\"block\">Confirm</ion-button>\n          </ion-col>\n        </ion-row>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n</ion-content>"

/***/ }),

/***/ "./src/app/pages/send-confirm/send-confirm.page.scss":
/*!***********************************************************!*\
  !*** ./src/app/pages/send-confirm/send-confirm.page.scss ***!
  \***********************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3BhZ2VzL3NlbmQtY29uZmlybS9zZW5kLWNvbmZpcm0ucGFnZS5zY3NzIn0= */"

/***/ }),

/***/ "./src/app/pages/send-confirm/send-confirm.page.ts":
/*!*********************************************************!*\
  !*** ./src/app/pages/send-confirm/send-confirm.page.ts ***!
  \*********************************************************/
/*! exports provided: SendConfirmPage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SendConfirmPage", function() { return SendConfirmPage; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/index.js");
/* harmony import */ var _send_pin_confirm_send_pin_confirm_page__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../send-pin-confirm/send-pin-confirm.page */ "./src/app/pages/send-pin-confirm/send-pin-confirm.page.ts");
...
var SendConfirmPage = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.modalController.create({
                            component: _send_pin_confirm_send_pin_confirm_page__WEBPACK_IMPORTED_MODULE_2__["SendPinConfirmPage"],
                            componentProps: { value: 123 }
                        })];
                    case 1:
                        modal = _a.sent();
    ...
    SendConfirmPage.prototype.dismiss = function (data) {
        this.modalController.dismiss(data);
    };
    SendConfirmPage = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'send-confirm-mozo',
            template: __webpack_require__(/*! ./send-confirm.page.html */ "./src/app/pages/send-confirm/send-confirm.page.html"),
...
/***/ "./src/app/pages/send-pin-confirm/send-pin-confirm.page.html":
/*!*******************************************************************!*\
  !*** ./src/app/pages/send-pin-confirm/send-pin-confirm.page.html ***!
  \*******************************************************************/
/*! no static exports found */
...
/***/ "./src/app/pages/send-pin-confirm/send-pin-confirm.page.scss":
/*!*******************************************************************!*\
  !*** ./src/app/pages/send-pin-confirm/send-pin-confirm.page.scss ***!
  \*******************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3BhZ2VzL3NlbmQtcGluLWNvbmZpcm0vc2VuZC1waW4tY29uZmlybS5wYWdlLnNjc3MifQ== */"

/***/ }),

/***/ "./src/app/pages/send-pin-confirm/send-pin-confirm.page.ts":
/*!*****************************************************************!*\
  !*** ./src/app/pages/send-pin-confirm/send-pin-confirm.page.ts ***!
  \*****************************************************************/
/*! exports provided: SendPinConfirmPage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SendPinConfirmPage", function() { return SendPinConfirmPage; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/index.js");
...
/* harmony import */ var _services_mozo_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../services/mozo.service */ "./src/app/services/mozo.service.ts");
...
var SendPinConfirmPage = /** @class */ (function () {
    ...
    SendPinConfirmPage.prototype.showSaveAddress = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.modalController.create({
                            component: _save_address_save_address_page__WEBPACK_IMPORTED_MODULE_6__["SaveAddressPage"],
    ...
    SendPinConfirmPage.prototype.getTransactionStatus = function (txHash) {
        var _this = this;
        var getTxStatus = setInterval(function () {
            _this.mozoService.getTransactionStatus(txHash).subscribe(function (res) {
                var data = res.body;
    ...
    SendPinConfirmPage = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'send-pin-confirm',
            template: __webpack_require__(/*! ./send-pin-confirm.page.html */ "./src/app/pages/send-pin-confirm/send-pin-confirm.page.html"),
            styles: [__webpack_require__(/*! ./send-pin-confirm.page.scss */ "./src/app/pages/send-pin-confirm/send-pin-confirm.page.scss")]
        }),
...
var MozoService = /** @class */ (function () {
    ...
    MozoService.prototype.getUserProfile = function () {
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apis.solomon + "/user-profile", { observe: 'response' });
    };
    MozoService.prototype.updateWalletInfo = function (data) {
        return this.http.put(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apis.solomon + "/user-profile/wallet", data, { observe: 'response' });
    };
    MozoService.prototype.getBalance = function (address) {
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apis.solomon + "/solo/contract/solo-token/balance/" + address, { observe: 'response' });
    };
    ...
    MozoService.prototype.sendSignedTransaction = function (data) {
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apis.solomon + "/solo/contract/solo-token/send-signed-tx", data, { observe: 'response' });
    };
    ;
    MozoService.prototype.getTransactionStatus = function (txHash) {
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apis.solomon + "/eth/solo/txs/" + txHash + "/status", { observe: 'response' });
    };
    ;
    MozoService.prototype.saveAddress = function (data) {
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apis.solomon + "/contacts", data, { observe: 'response' });
    };
    ;
    MozoService = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])({
            providedIn: 'root'
        }),
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]])
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _helpers_EncryptionUtils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../helpers/EncryptionUtils */ "./src/app/helpers/EncryptionUtils.js");
/* harmony import */ var _helpers_EncryptionUtils__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_helpers_EncryptionUtils__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _wallet__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./wallet */ "./src/app/utils/wallet.ts");
/* harmony import */ var _transaction__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./transaction */ "./src/app/utils/transaction.ts");



/* harmony default export */ __webpack_exports__["default"] = ({
    encryption: _helpers_EncryptionUtils__WEBPACK_IMPORTED_MODULE_0__,
    wallet: new _wallet__WEBPACK_IMPORTED_MODULE_1__["Wallet"](),
    transaction: new _transaction__WEBPACK_IMPORTED_MODULE_2__["Transaction"]()
});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(Buffer) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Transaction", function() { return Transaction; });
...
/* harmony import */ var _helpers_EncryptionUtils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../helpers/EncryptionUtils */ "./src/app/helpers/EncryptionUtils.js");
/* harmony import */ var _helpers_EncryptionUtils__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_helpers_EncryptionUtils__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var bitcoinjs_lib__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! bitcoinjs-lib */ "./node_modules/bitcoinjs-lib/src/index.js");
...
var Transaction = /** @class */ (function () {
    function Transaction() {
         ...
         * @return {String}
         */
        this.serialize = function (v, r, s) {
            var rB = this.canonicalizeInt(r);
            var sB = this.canonicalizeInt(s);
            var prefix = "30" + (rB.length + sB.length + 4).toString(16);
            var rStr = "02" + rB.length.toString(16) + rB.toString('hex');
            var sStr = "02" + sB.length.toString(16) + sB.toString('hex');
            var result = prefix.concat(rStr, sStr);
         ...
         * @return {Array}
         */
        this.canonicalizeInt = function (bufferData) {
         ...
         */
        this.getAllPrivateKeys = function (pin, inputs, coinType) {
            var privKeys = [];
            for (var i = 0; i < inputs.length; i++) {
                ...
                //}
                var encryptedPrivateKey = ""; //addressDAO.getPrivateKeyFromAddress(address);
                if (!encryptedPrivateKey) {
                    return null;
                }
                var privateKey = _helpers_EncryptionUtils__WEBPACK_IMPORTED_MODULE_2___default.a.decrypt(encryptedPrivateKey, pin);
     ...
     * @returns {Object}
     */
    Transaction.prototype.signTxMessage = function (tosign, privateKey, net) {
        try {
            var sign = null;
            var publicKey = null;
            if (web3__WEBPACK_IMPORTED_MODULE_0___default.a.utils.isHex(privateKey)) { //ETH
                var bufferPrikey = ethereumjs_util__WEBPACK_IMPORTED_MODULE_1___default.a.toBuffer(privateKey);
                // Remove the prefix "0x" if any
                var tosignBuffer = new Buffer(tosign.replace("0x", ""), "hex");
                var msgSign = ethereumjs_util__WEBPACK_IMPORTED_MODULE_1___default.a.ecsign(tosignBuffer, bufferPrikey);
                publicKey = ethereumjs_util__WEBPACK_IMPORTED_MODULE_1___default.a.privateToPublic(bufferPrikey).toString('hex');
                console.log('Public key: ' + publicKey);
                sign = this.serialize(msgSign.v, msgSign.r, msgSign.s);
                console.log('Sign: ' + sign);
            }
            else { //BTC
                var keyPair = new bitcoinjs_lib__WEBPACK_IMPORTED_MODULE_3___default.a.ECPair.fromWIF(privateKey, net);
     ...
     */
    Transaction.prototype.signTransaction = function (txData, privateKey, callback) {
        var _this = this;
        try {
            var validateTx = txData.params;
            //var network = txData.network;
            var net_1 = bitcoinjs_lib__WEBPACK_IMPORTED_MODULE_3___default.a.networks.testnet;
            // signing each of the hex-encoded string required to finalize the transaction
            validateTx.pubkeys = [];
            validateTx.signatures = [];
            validateTx.tosign.map(function (tosign, index) {
                var sign = _this.signTxMessage(tosign, privateKey, net_1);
                console.log('Sign: ' + sign);
            ...
            var signedTransaction = JSON.stringify(validateTx);
            if (typeof callback === 'function') {
    ...
    Transaction.prototype.signMultipleTransactions = function (txInputData, privateKey, callback) {
        ...
        var _loop_1 = function (index) {
            ...
            try {
                ...
                var net_2 = bitcoinjs_lib__WEBPACK_IMPORTED_MODULE_3___default.a.networks.testnet;
                // signing each of the hex-encoded string required to finalize the transaction
                validateTx.pubkeys = [];
                validateTx.signatures = [];
                validateTx.tosign.map(function (tosign, index) {
...
/* harmony import */ var _helpers_EncryptionUtils__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_helpers_EncryptionUtils__WEBPACK_IMPORTED_MODULE_3__);
...
var Wallet = /** @class */ (function () {
     ...
     */
    Wallet.prototype.generateAddressAtIndex = function (wallet, addressIndex) {
        try {
            ...
            var checksumAddress = ethereumjs_util__WEBPACK_IMPORTED_MODULE_2___default.a.toChecksumAddress(hexAddress);
            address = ethereumjs_util__WEBPACK_IMPORTED_MODULE_2___default.a.addHexPrefix(checksumAddress);
            privkey = ethereumjs_util__WEBPACK_IMPORTED_MODULE_2___default.a.addHexPrefix(privkey);
            return {
                address: address,
     ...
     * @return {Array}
     */
    Wallet.prototype.createNewWallet = function (importedPhrase, pin, mustSave) {
        var mnemonic = importedPhrase ||
            bip39__WEBPACK_IMPORTED_MODULE_0___default.a.generateMnemonic(128, null, bip39__WEBPACK_IMPORTED_MODULE_0___default.a.wordlists.english);
        if (mustSave) {
            // Save PIN and mnemonic
            var encryptedMnemonic = _helpers_EncryptionUtils__WEBPACK_IMPORTED_MODULE_3__["encrypt"](mnemonic, pin);
        }
        var wallets = this.generateWallets(mnemonic);
        return wallets;
    };
    /**
    ...
    Wallet.prototype.generateMnemonic = function () {
        var mnemonic = bip39__WEBPACK_IMPORTED_MODULE_0___default.a.generateMnemonic(128, null, bip39__WEBPACK_IMPORTED_MODULE_0___default.a.wordlists.english);
        return mnemonic;
    };
    return Wallet;
}());
...
module.exports = __webpack_require__(/*! /PROJECTS/BigLab/mozo-wallet/src/main.ts */"./src/main.ts");
